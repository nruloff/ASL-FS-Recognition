def create_text_vectorizer(include_transition_keys=True, include_capitalization=False, seq_length_input=MAX_FRAME_LENGTH):
  '''
  INPUT
  ...
  # Build the TextVectorizer for English Test translation to numbers
  vectorizer=tf.keras.layers.TextVectorization(standardize=None,
                                               ...
                                               output_sequence_length=(seq_length_input+1))
  return vectorizer, all_keys
